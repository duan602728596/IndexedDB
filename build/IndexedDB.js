...
(function (factory) {
    ...
    /* 兼容不同浏览器 */
    IndexedDB.indexeddb = _window.indexedDB || _window.webkitIndexedDB || _window.mozIndexedDB || _window.msIndexedDB;
    ...
    IndexedDB.prototype.Init = function (name, version, callbackObject) {
         ...
         *
         */
        this.getObjectStore = function (objectStoreName) {
            var writeAble = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
    ...
    ObjectStore.prototype.delete = function (value) {
        ...
        for (var i = 0, j = value.length - 1; i <= j; i++) {
